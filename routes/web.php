...
|--------------------------------------------------------------------------
| This is only for fixing environment cache issues. Visit /clear once
| after editing .env, then delete this route for security reasons.*/

Route::get('/clear', function () {
    Artisan::call('config:clear');
    Artisan::call('cache:clear');
    Artisan::call('config:cache');
    return '✅ Laravel configuration and cache cleared successfully!';
});
...
/*Route::get('/dbcheck', function () {
    try {
        ...
        return "<h3>✅ Connected to database:</h3> 
                <b>{$databaseName}</b><br><br>
                <h4>Total tables: {$tableCount}</h4>";
    } catch (Exception $e) {
