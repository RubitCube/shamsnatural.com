                                                            ...
                                                            @foreach ($productListNatural as $productDetails)
                                                                <tr>
                                                                    ...
                                                                    <td class="wd-sm-10p">
                                                                        ...
                                                                        @php
                                                                            $desc = trim($productDetails->product_desc);
                                                                        @endphp

                                                                        @if (!empty($desc))
                                                                            <textarea readonly class="textAreadDesc">{{ $desc }}</textarea>
                                                                        @endif
                                                                    </td>
                                                            ...
                                                            @foreach ($productListEssentials as $productDetailsEssential)
                                                                <tr>
                                                                    ...
                                                                    <td class="wd-sm-10p">
                                                                        ...
                                                                        {{ $productDetailsEssential->product_name }}
                                                                        <br /><br />

                                                                        @php
                                                                            $desc = trim(
                                                                                $productDetailsEssential->product_desc,
                                                                            );
                                                                        @endphp
