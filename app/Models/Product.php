...
class Product extends Model
{
    ...
    protected $fillable = [
        'id', 'product_name','product_desc', 'product_code', 'prdouct_image', 'status', 'product_category' , 'product_size', 'product_price', 'length', 'width', 'height', 'qty_per_box', 'weight_per_box'
    ];
